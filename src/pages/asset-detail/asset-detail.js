...
var AssetDetailPage = /** @class */ (function () {
    function AssetDetailPage(navCtrl, navParams) {
    ...
    AssetDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AssetDetailPage');
    };
    AssetDetailPage.decorators = [
        { type: Component, args: [{
    ...
    /** @nocollapse */
    AssetDetailPage.ctorParameters = function () { return [
        { type: NavController, },
        { type: NavParams, },
    ]; };
    /**
